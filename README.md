...
### `vinceworks sandbox`
A remote dev environment on the home Ubuntu box where agents can work with high autonomy on personal projects, reachable from the Mac or phone from anywhere. See [sandbox/README.md](sandbox/README.md).
